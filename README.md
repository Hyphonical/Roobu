...
Options:
  --site <SITE>                  Optional site selector: rule34|e621|safebooru|xbooru|kemono|aibooru|danbooru|civitai|e6ai|gelbooru|konachan|yandere (omit to run all supported sites sequentially)
